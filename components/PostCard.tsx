...
export default function PostCard({ post }: PostCardProps) {
  ...
  return (
    <a
      ...
      className="group flex items-start gap-3 rounded-xl border border-zinc-200 bg-white p-3 shadow-sm transition-all hover:border-zinc-300 hover:shadow-md dark:border-zinc-700 dark:bg-zinc-900 dark:hover:border-zinc-600 sm:p-4"
    >
      {/* Source badge */}
      <span
      ...
      <div className="min-w-0 flex-1">
        <h3 className="line-clamp-2 text-sm font-semibold text-zinc-900 group-hover:text-blue-600 dark:text-zinc-50 dark:group-hover:text-blue-400 sm:text-base">
          {post.title}
        </h3>

        {/* Stats row */}
        <div className="mt-1.5 flex items-center gap-3 text-xs text-zinc-500 dark:text-zinc-400 sm:text-sm">
